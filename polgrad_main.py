...
def main():
	...
	with tf.Session() as sess:
		...
		print(evaluate_player(lambda g: runner.play(g, board=to_dense_input(g.array), session=sess), randai.play, rules=rules, games=100))
		print(evaluate_player(randai.play, lambda g: runner.play(g, board=to_dense_input(g.array), session=sess), rules=rules, games=100))
		print(evaluate_player(lambda g: runner.play(g, board=to_dense_input(g.array), session=sess), emacai.play, rules=rules, games=1))
		print(evaluate_player(emacai.play, lambda g: runner.play(g, board=to_dense_input(g.array), session=sess), rules=rules, games=1))
		...
		print(play_game(human.play, lambda g: runner.play(g, board=to_dense_input(g.array), session=sess, return_probs=True), rules=rules, print_board=True))
